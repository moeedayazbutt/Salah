...
export function determineSkyPhase(elevation: number, azimuth = 90): SkyPhase {
  const phases: Record<string, { name: string; gradient: string; pattern: string; patternOpacity: number }> = {
    night: {
      name: 'Night',
      gradient: 'linear-gradient(180deg, #060810 0%, #0A0D1E 30%, #0E1230 70%, #111530 100%)',
      pattern: 'girih-tiles', patternOpacity: 0.03,
    },
    fajr: {
      name: 'Fajr',
      gradient: 'linear-gradient(180deg, #0A0D1E 0%, #1A1F4A 25%, #2D2B6B 50%, #4A3B7E 75%, #6B4A8A 100%)',
      pattern: 'eight-point-star', patternOpacity: 0.025,
    },
    sunrise: {
      name: 'Sunrise',
      gradient: 'linear-gradient(180deg, #1A1F4A 0%, #4A3060 15%, #8A4A60 30%, #C46A4C 50%, #E88A4A 70%, #F5B06A 85%, #FFE090 100%)',
      pattern: 'muqarnas', patternOpacity: 0.03,
    },
    morning: {
      name: 'Morning',
      gradient: 'linear-gradient(180deg, #E8C070 0%, #F0D080 15%, #B8DCF0 40%, #80C8EE 65%, #50B0E8 85%, #3498DB 100%)',
      pattern: 'girih-tiles', patternOpacity: 0.02,
    },
    midday: {
      name: 'Midday',
      gradient: 'linear-gradient(180deg, #60C0F0 0%, #3498DB 20%, #2080C0 45%, #1868A8 70%, #104878 100%)',
      pattern: 'kufic-border', patternOpacity: 0.015,
    },
    afternoon: {
      name: 'Afternoon',
      gradient: 'linear-gradient(180deg, #2080C0 0%, #3498DB 20%, #60C0EE 45%, #A0D4EE 65%, #D0B870 85%, #E8A858 100%)',
      pattern: 'girih-tiles', patternOpacity: 0.02,
    },
    sunset: {
      name: 'Sunset',
      gradient: 'linear-gradient(180deg, #D0A050 0%, #E07030 20%, #C03020 40%, #901840 55%, #601060 70%, #380848 85%, #200030 100%)',
      pattern: 'muqarnas', patternOpacity: 0.035,
    },
    maghrib: {
      name: 'Maghrib',
      gradient: 'linear-gradient(180deg, #300840 0%, #481060 20%, #502070 35%, #603090 50%, #481880 65%, #301060 80%, #180830 100%)',
      pattern: 'eight-point-star', patternOpacity: 0.025,
    },
    isha: {
      name: 'Isha',
      gradient: 'linear-gradient(180deg, #180828 0%, #100820 30%, #0C0C1C 60%, #080A18 100%)',
      pattern: 'girih-tiles', patternOpacity: 0.02,
    },
  };

  // Use azimuth to distinguish morning (sun in east, az<180) from afternoon (sun in west, az>180)
