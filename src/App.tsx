    ...
    <div className={`w-full h-screen overflow-hidden relative bg-[#080A1A]${aodMode ? ' aod-mode' : ''}`}>
      ...
      {!hasLocation ? (
        ...
        <div className="relative z-10 w-full h-full flex main-content" style={{
          padding: '4px 6px',
          paddingBottom: aodMode ? '4px' : '56px',
          gap: '6px',
        }}>
      ...
      <div className="fixed z-20 flex items-center" style={{ bottom: aodMode ? '4px' : '60px', right: '6px', gap: '6px' }}>
        <button
        ...
        <button
          ...
          aria-label={aodMode ? 'Disable always-on display' : 'Enable always-on display'}
          title={aodMode ? 'Exit AOD mode' : 'Always-on display'}
          className="flex items-center justify-center cursor-pointer border-none transition-all duration-200"
          style={{
            width: 44,
            height: 44,
            borderRadius: '50%',
            background: aodMode ? 'rgba(255,255,255,0.12)' : 'rgba(255,255,255,0.06)',
            backdropFilter: 'blur(12px)',
            WebkitBackdropFilter: 'blur(12px)',
            border: `1px solid ${aodMode ? 'rgba(255,255,255,0.3)' : 'rgba(255,255,255,0.08)'}`,
            color: aodMode ? '#FAFAFA' : 'rgba(255,255,255,0.5)',
          }}
          onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(255,255,255,0.1)'; }}
          onMouseLeave={(e) => { e.currentTarget.style.background = aodMode ? 'rgba(255,255,255,0.12)' : 'rgba(255,255,255,0.06)'; }}
        >
